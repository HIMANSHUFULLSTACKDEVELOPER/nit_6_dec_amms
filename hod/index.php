...
<div class="quick-action-card">
    <a href="student_resumes.php" class="action-link">
        <div class="action-icon" style="background: linear-gradient(135deg, #667eea, #764ba2);">
            📄
        </div>
        <div class="action-content">
            <h3>Student Resumes</h3>
            <p>View all student resumes (<?php echo $resume_count; ?> available)</p>
        </div>
...
<div style="margin-top: 40px;">
    <h3 style="color: #2c3e50; font-size: 24px; font-weight: 700; margin-bottom: 20px; padding: 15px; background: rgba(255, 255, 255, 0.9); border-radius: 15px; border-left: 5px solid #667eea;">
        ⚙️ Tools
    </h3>
    
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
        
        <a href="manage_students.php" style="background: linear-gradient(135deg, #667eea, #764ba2); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(102, 126, 234, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(102, 126, 234, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(102, 126, 234, 0.3)';">
            <span style="font-size: 24px;">👨‍🎓</span>
            <span>Manage Students</span>
        </a>

        <a href="manage_teachers.php" style="background: linear-gradient(135deg, #f093fb, #f5576c); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(240, 147, 251, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(240, 147, 251, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(240, 147, 251, 0.3)';">
            <span style="font-size: 24px;">👨‍🏫</span>
            <span>Manage Teachers</span>
        </a>

        <a href="manage_classes.php" style="background: linear-gradient(135deg, #4facfe, #00f2fe); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(79, 172, 254, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(79, 172, 254, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(79, 172, 254, 0.3)';">
            <span style="font-size: 24px;">🏛️</span>
            <span>Manage Classes</span>
        </a>

        <a href="assign_classes.php" style="background: linear-gradient(135deg, #43e97b, #38f9d7); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(67, 233, 123, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(67, 233, 123, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(67, 233, 123, 0.3)';">
            <span style="font-size: 24px;">🎯</span>
            <span>Assign Classes</span>
        </a>

        <a href="manage_parents.php" style="background: linear-gradient(135deg, #fa709a, #fee140); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(250, 112, 154, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(250, 112, 154, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(250, 112, 154, 0.3)';">
            <span style="font-size: 24px;">👪</span>
            <span>Manage Parents</span>
        </a>

        <a href="manage_subjects.php" style="background: linear-gradient(135deg, #30cfd0, #330867); color: white; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(48, 207, 208, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(48, 207, 208, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(48, 207, 208, 0.3)';">
            <span style="font-size: 24px;">📚</span>
            <span>Manage Subjects</span>
        </a>

        <a href="manage_subject_teachers.php" style="background: linear-gradient(135deg, #ff9a9e, #fecfef); color: #333; padding: 15px 20px; border-radius: 12px; text-decoration: none; display: flex; align-items: center; gap: 12px; box-shadow: 0 5px 15px rgba(255, 154, 158, 0.3); transition: all 0.3s ease; font-weight: 600; font-size: 14px;" onmouseover="this.style.transform='translateX(5px)'; this.style.boxShadow='0 8px 20px rgba(255, 154, 158, 0.4)';" onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 5px 15px rgba(255, 154, 158, 0.3)';">
            <span style="font-size: 24px;">👥</span>
    ...
    <div class="footer">
        ...
        <div class="footer-content">
            <div class="developer-section">
                ...
                <p class="team-label">💻 Intellectual property owned by</p>
                <div class="developer-badges">
                  
                    <a href="https://himanshufullstackdeveloper.github.io/hp3/" class="developer-badge">
                        <span>👨‍💻</span>
