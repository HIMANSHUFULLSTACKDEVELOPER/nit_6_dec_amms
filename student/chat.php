...
<body>
    ...
    <div class="chat-container">
        ...
        <div class="contacts-panel">
            <div class="contacts-header">
                👨‍🏫 Teachers & HOD (<span id="teacherCount">0</span>)
            </div>
    ...
    <script>
        ...
        function loadContacts() {
            ...
            .then(data => {
                debugLog('Contacts response:', data);
                
                if (data.success) {
                    contacts = data.contacts;
                    document.getElementById('teacherCount').textContent = data.total || contacts.length;
        ...
        function renderContacts(contactsList) {
            debugLog('Rendering contacts:', contactsList.length);
        ...
        function sendMessage() {
            ...
            debugLog('Sending message:', {
                ...
                receiver_type: currentContact.type,
            ...
            .then(response => {
                debugLog('Send response status:', response.status);
                return response.text();
            })
            .then(text => {
                debugLog('Send response text:', text);
                try {
                    const data = JSON.parse(text);
                    debugLog('Send response data:', data);
